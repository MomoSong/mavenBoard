...
public class Pagination {
	...
	public String getPagination() {
		...
		if(this.page != 1){
			buffer.append("<span><a href=\"" + this.url + "?page=" + 1 + "&search=" + this.search +"\"><<</a></span>");
		}
		
		if(this.getBlockStart() > 1) {
			buffer.append("<span><a href=\"" + this.url + "?page=" + this.getBlockPrev() + "&search=" + this.search +"\"><</a></span>");
		}
		...
		for(int i = this.getBlockStart(); i <= this.getBlockEnd(); i++) {
			if(page == i)
				...
				buffer.append("<span><a href=\"" + this.url + "?page=" + i + "&search=" + this.search +"\">" + i + "</a></span>");
		}
		
		if(this.getBlockEnd() < endPage) {
			buffer.append("<span><a href=\"" + this.url + "?page=" + this.getBlockNext()+ "&search=" + this.search  + "\">></a></span>");
		}
		
		if(this.page != endPage){
			buffer.append("<span><a href=\"" + this.url + "?page=" + this.endPage + "&search=" + this.search +"\">>></a></span>");
		}
	...
	public String toString() {
		return "Pagination [page=" + page + ", endPage=" + endPage + ", start="
				...
				+ ", blockSize=" + blockSize + ", url=" + url + ", search="
